...
from portafolio.views.experiencia_views import (
    ExperienciaCreateView, ExperienciaUpdateView, ExperienciaDeleteView, ExperienciaDetailView
)
...
from portafolio.views.sociallink_views import (
    SocialLinkCreateView, SocialLinkUpdateView, SocialLinkDeleteView, SocialLinkDetailView
)
from portafolio.views.projecto_views import (
    ProjectoCreateView, ProjectoUpdateView, ProjectoDeleteView, ProjectoDetailView
)
from portafolio.views.estudios_views import (
    EstudiosCreateView, EstudiosUpdateView, EstudiosDeleteView, EstudiosDetailView
)
